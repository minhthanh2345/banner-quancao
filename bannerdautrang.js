...
$(window).load(function() {
		if(document.cookie.indexOf("adf") == -1)
		{
			...
			$("#myModal").html("<a href='http://faceseo.vn/images/banner-linh-nguyen.gif' width='500px'/><br/>TẶNG NGAY 10% KHI MUA ĐÀN PIANO</a>. GỌI NGAY 0909 736 782 MS HƯƠNG. <h2><a class='close-nguyentrong-modal'>X</a></h2>");
